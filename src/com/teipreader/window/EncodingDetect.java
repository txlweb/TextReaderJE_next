 ...
 * <p>
 * com.teipreader.Lib.com.teipreader.window.EncodingDetect.java<br>
 * 自动获取文件的编码
 *
 * @author Billows.Van
 * @version 1.0
...
class BytesEncodingDetect extends Encoding {
    ...
    /**
     * Function : detectEncoding Aruguments: URL Returns : One of the encodings from the com.teipreader.Lib.com.teipreader.window.Encoding enumeration (GB2312, HZ, BIG5,
    ...
    /**
     * Function : detectEncoding Aruguments: File Returns : One of the encodings from the com.teipreader.Lib.com.teipreader.window.Encoding enumeration (GB2312, HZ, BIG5,
    ...
    /**
     * Function : detectEncoding Aruguments: byte array Returns : One of the encodings from the com.teipreader.Lib.com.teipreader.window.Encoding enumeration (GB2312, HZ,
    ...
    public int detectEncoding(byte[] rawtext) {
        ...
        for (index = 0; index < TOTALTYPES; index++) {
            if (debug)
                System.err.println("com.teipreader.Lib.com.teipreader.window.Encoding " + nicename[index] + " score " + scores[index]);
...
class Encoding {
    ...
    // Supported com.teipreader.Lib.com.teipreader.window.Encoding Types
